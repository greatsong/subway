...
if not os.path.exists(csv_file_path):
    ...
    try:
        ...
        def plot_comparison(station_data_1, station_data_2, station_name_1, station_name_2, time_periods):
            ...
            ax.plot(x, boardings_1, label=f'{station_name_1} 승차', color='blue', marker='o')
            ax.plot(x, alightings_1, label=f'{station_name_1} 하차', color='green', marker='o')
            ax.plot(x, boardings_2, label=f'{station_name_2} 승차', color='red', marker='o')
            ax.plot(x, alightings_2, label=f'{station_name_2} 하차', color='orange', marker='o')
            ...
            for i in range(len(time_periods)):
                ax.text(i, boardings_1[i] + 5, str(boardings_1[i]), ha='center', fontsize=10, color='blue')
                ax.text(i, alightings_1[i] + 5, str(alightings_1[i]), ha='center', fontsize=10, color='green')
                ax.text(i, boardings_2[i] + 5, str(boardings_2[i]), ha='center', fontsize=10, color='red')
                ax.text(i, alightings_2[i] + 5, str(alightings_2[i]), ha='center', fontsize=10, color='orange')
